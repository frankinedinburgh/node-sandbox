...
(async () => {
    ...
    try {
        let hotelData = await page.evaluate(() => {
            ...
            let priceChange = document.querySelectorAll('.figures span')[0];
            let priceChangePercentage = document.querySelectorAll('.figures span')[1];
            let prevPrice = document.querySelectorAll('.figures span')[2];
